...
| [`attribution/token_attribution.py`](attribution/token_attribution.py) | token-level attribution (`attribution_granularity="token"`), GradDot and K-FAC | `dattri`, `transformers` |
